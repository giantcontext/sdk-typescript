...
declare class BuilderResource extends BaseResource {
     ...
     */
    setContentVisibility: ({ organizationId, projectId, data, }: {
        organizationId: string;
        projectId: string;
        data: {
            contentType: string;
...
declare class CRMResource extends BaseResource {
     ...
     */
    listCrmCompanyContacts: ({ organizationId, projectId, appId, companyId, page, pageSize, lite, sort, search, status, source, title, department, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        companyId: string;
     ...
     */
    listCrmCompanyEdges: ({ organizationId, projectId, appId, companyId, page, pageSize, lite, limit, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        companyId: string;
...
declare class ChatResource extends BaseResource {
     ...
     */
    replyToChatConversation: ({ organizationId, projectId, appId, conversationId, data, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        conversationId: string;
     ...
     */
    takeOverChatConversation: ({ organizationId, projectId, appId, conversationId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        conversationId: string;
     ...
     */
    releaseChatConversation: ({ organizationId, projectId, appId, conversationId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        conversationId: string;
     ...
     */
    getChatConversationTimeline: ({ organizationId, projectId, appId, conversationId, page, pageSize, lite, limit, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        conversationId: string;
     ...
     */
    listChatEscalations: ({ organizationId, projectId, appId, page, pageSize, lite, sort, search, status, visitorEmail, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        page?: string;
...
declare class DevelopersResource extends BaseResource {
     ...
     */
    listDevelopersDocs: ({ organizationId, projectId, appId, page, pageSize, lite, sort, search, status, isListed, categoryId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        page?: string;
...
declare class KBResource extends BaseResource {
     ...
     */
    listKbArticles: ({ organizationId, projectId, appId, page, pageSize, lite, sort, search, name, slug, status, isListed, categoryId, createdAt, updatedAt, publishedAt, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        page?: string;
...
declare class PeopleResource extends BaseResource {
     ...
     */
    erasePerson: ({ organizationId, projectId, personId, }: {
        organizationId: string;
        projectId: string;
        personId: string;
    }) => Promise<unknown>;
     ...
     */
    setPersonField: ({ organizationId, projectId, personId, data, }: {
        organizationId: string;
        projectId: string;
        personId: string;
        data: {
     ...
     */
    listPersonEdges: ({ organizationId, projectId, personId, page, pageSize, lite, limit, }: {
        organizationId: string;
        projectId: string;
        personId: string;
        page?: string;
     ...
     */
    tagPerson: ({ organizationId, projectId, personId, data, }: {
        organizationId: string;
        projectId: string;
        personId: string;
        data: {
     ...
     */
    untagPerson: ({ organizationId, projectId, personId, data, }: {
        organizationId: string;
        projectId: string;
        personId: string;
        data: {
     ...
     */
    getPersonPropertyKeys: ({ organizationId, projectId, }: {
        organizationId: string;
        projectId: string;
    }) => Promise<{
        keys: Array<{
     ...
     */
    mergePersonPropertyKeys: ({ organizationId, projectId, data, }: {
        organizationId: string;
        projectId: string;
        data: {
            fromKey: string;
     ...
     */
    getPerson: ({ organizationId, projectId, personId, }: {
        organizationId: string;
        projectId: string;
        personId: string;
    }) => Promise<{
     ...
     */
    updatePerson: ({ organizationId, projectId, personId, data, }: {
        organizationId: string;
        projectId: string;
        personId: string;
        data: {
     ...
     */
    getPersonByEmail: ({ organizationId, projectId, email, }: {
        organizationId: string;
        projectId: string;
        email: string;
    }) => Promise<{
     ...
     */
    identify: ({ organizationId, projectId, data, }: {
        organizationId: string;
        projectId: string;
        data: {
            email: string;
     ...
     */
    listErasures: ({ organizationId, projectId, page, pageSize, lite, }: {
        organizationId: string;
        projectId: string;
        page?: string;
        pageSize?: string;
     ...
     */
    listPeople: ({ organizationId, projectId, page, pageSize, lite, sort, search, status, source, title, department, locale, }: {
        organizationId: string;
        projectId: string;
        page?: string;
        pageSize?: string;
     ...
     */
    createPerson: ({ organizationId, projectId, data, }: {
        organizationId: string;
        projectId: string;
        data: {
            firstName: string;
     ...
     */
    track: ({ organizationId, projectId, data, }: {
        organizationId: string;
        projectId: string;
        data: {
            visitorId: string;
...
declare class WebsiteResource extends BaseResource {
     ...
     */
    getWebsiteBlogPage: ({ organizationId, projectId, appId, draftId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        draftId?: string;
     ...
     */
    updateWebsiteBlogPageMeta: ({ organizationId, projectId, appId, data, draftId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        data: {
     ...
     */
    getWebsiteNotFoundPage: ({ organizationId, projectId, appId, draftId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        draftId?: string;
     ...
     */
    updateWebsiteNotFoundPageMeta: ({ organizationId, projectId, appId, data, draftId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        data: {
     ...
     */
    listWebsitePages: ({ organizationId, projectId, appId, page, pageSize, lite, sort, search, status, slug, isListed, layoutId, headerId, footerId, createdAt, updatedAt, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        page?: string;
     ...
     */
    listWebsitePosts: ({ organizationId, projectId, appId, page, pageSize, lite, sort, search, status, slug, isListed, authorId, authorName, publishDate, createdAt, updatedAt, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        page?: string;
     ...
     */
    getWebsiteSignInPage: ({ organizationId, projectId, appId, draftId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        draftId?: string;
     ...
     */
    updateWebsiteSignInPageMeta: ({ organizationId, projectId, appId, data, draftId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        data: {
     ...
     */
    getWebsiteViewerAuth: ({ organizationId, projectId, appId, }: {
        organizationId: string;
        projectId: string;
        appId: string;
    }) => Promise<{
     ...
     */
    removeWebsiteViewer: ({ organizationId, projectId, appId, uid, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        uid: string;
     ...
     */
    listWebsiteViewers: ({ organizationId, projectId, appId, page, pageSize, lite, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        page?: string;
     ...
     */
    inviteWebsiteViewer: ({ organizationId, projectId, appId, data, }: {
        organizationId: string;
        projectId: string;
        appId: string;
        data: {
