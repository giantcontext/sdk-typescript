...
class AppMembersResource extends BaseResource {
	...
	getAppMember = async ({
		...
		projectAppId: string;
		userId: string;
		role: "owner" | "admin" | "editor" | "viewer" | "sender";
		title?: string;
		invitedBy?: string;
		joinedAt?: string;
		createdAt: string;
...
class BuilderResource extends BaseResource {
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/content/visibility
	 */
	setContentVisibility = async ({
		organizationId,
		projectId,
		data,
	}: {
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/content/visibility`;
		return this.request<{
			contentType: string;
			contentId: string;
			isListed: boolean;
...
class CRMResource extends BaseResource {
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/crm/{appId}/companies/{companyId}/edges
	 */
	listCrmCompanyEdges = async ({
		organizationId,
		projectId,
		appId,
		companyId,
	...
	> => {
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/crm/${encodeURIComponent(String(appId))}/companies/${encodeURIComponent(String(companyId))}/edges`;
		const params = this.cleanParams({ page, pageSize, lite, limit });
		return this.request<
			Array<{
				id: string;
				projectId: string;
...
class ChatResource extends BaseResource {
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/reply
	 */
	replyToChatConversation = async ({
		organizationId,
		projectId,
		appId,
		conversationId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/chat/${encodeURIComponent(String(appId))}/conversations/${encodeURIComponent(String(conversationId))}/reply`;
		return this.request<unknown>(endpoint, { method: "POST", data });
	};

	/**
	 * Take over a chat conversation from the AI
	 * @method POST /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/takeover
	 */
	takeOverChatConversation = async ({
		organizationId,
		projectId,
		appId,
		conversationId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/chat/${encodeURIComponent(String(appId))}/conversations/${encodeURIComponent(String(conversationId))}/takeover`;
		return this.request<{
			heldByUserId: string | unknown;
			heldAt: string | unknown;
		}>(endpoint, { method: "POST" });
	 ...
	 * @method DELETE /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/takeover
	 */
	releaseChatConversation = async ({
		organizationId,
		projectId,
		appId,
		conversationId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/chat/${encodeURIComponent(String(appId))}/conversations/${encodeURIComponent(String(conversationId))}/takeover`;
		return this.request<unknown>(endpoint, { method: "DELETE" });
	};

	/**
	 * The visitor's trail behind a conversation, newest first
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/timeline
	 */
	getChatConversationTimeline = async ({
		organizationId,
		projectId,
		appId,
		conversationId,
	...
	> => {
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/chat/${encodeURIComponent(String(appId))}/conversations/${encodeURIComponent(String(conversationId))}/timeline`;
		const params = this.cleanParams({ page, pageSize, lite, limit });
		return this.request<
			Array<{
				id: string;
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/escalations
	 */
	listChatEscalations = async ({
		organizationId,
		projectId,
		appId,
		page,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/chat/${encodeURIComponent(String(appId))}/escalations`;
		const params = this.cleanParams({
			page,
			pageSize,
			lite,
...
class PeopleResource extends BaseResource {
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/people/{personId}/erasures
	 */
	erasePerson = async ({
		organizationId,
		projectId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/${encodeURIComponent(String(personId))}/erasures`;
		return this.request<unknown>(endpoint, { method: "POST" });
	};

	/**
	 * Set one custom field on a person, merging into properties
	 * @method PUT /organizations/{organizationId}/projects/{projectId}/people/{personId}/fields
	 */
	setPersonField = async ({
		organizationId,
		projectId,
		personId,
		data,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/${encodeURIComponent(String(personId))}/fields`;
		return this.request<{
			id: string;
			projectId: string;
			firstName: string | unknown;
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/people/{personId}/edges
	 */
	listPersonEdges = async ({
		organizationId,
		projectId,
		personId,
		page,
	...
	> => {
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/${encodeURIComponent(String(personId))}/edges`;
		const params = this.cleanParams({ page, pageSize, lite, limit });
		return this.request<
			Array<{
				id: string;
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/people/{personId}/tags
	 */
	tagPerson = async ({
		organizationId,
		projectId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/${encodeURIComponent(String(personId))}/tags`;
		return this.request<{
			id: string;
			projectId: string;
			firstName: string | unknown;
	 ...
	 * @method DELETE /organizations/{organizationId}/projects/{projectId}/people/{personId}/tags
	 */
	untagPerson = async ({
		organizationId,
		projectId,
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/people/property-keys
	 */
	getPersonPropertyKeys = async ({
		organizationId,
		projectId,
	}: {
		organizationId: string;
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/property-keys`;
		return this.request<{
			keys: Array<{
				key: unknown;
				people: unknown;
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/people/property-keys
	 */
	mergePersonPropertyKeys = async ({
		organizationId,
		projectId,
		data,
	}: {
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/people/{personId}
	 */
	getPerson = async ({
		organizationId,
		projectId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/${encodeURIComponent(String(personId))}`;
		return this.request<{
			id: string;
			projectId: string;
			firstName: string | unknown;
	...
	/**
	 * Update person
	 * @method PATCH /organizations/{organizationId}/projects/{projectId}/people/{personId}
	 */
	updatePerson = async ({
		organizationId,
		projectId,
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/people/by-email
	 */
	getPersonByEmail = async ({
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/by-email`;
		const params = this.cleanParams({ email });
		return this.request<{
			id: string;
			projectId: string;
			firstName: string | unknown;
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/people/identify
	 */
	identify = async ({
		organizationId,
		projectId,
		...
		outcome: "identified" | "suppressed";
		personId?: string;
		personCreated?: boolean;
		visitorLinked?: boolean;
		visitorReason?: "foreign" | "severed" | "suppressed";
	}> => {
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people/identify`;
		return this.request<{
			outcome: "identified" | "suppressed";
			personId?: string;
			personCreated?: boolean;
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/erasures
	 */
	listErasures = async ({
		organizationId,
		projectId,
	...
	> => {
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/erasures`;
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/people
	 */
	listPeople = async ({
		organizationId,
		projectId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/people`;
		const params = this.cleanParams({
			page,
			pageSize,
			lite,
	...
	/**
	 * Create person
	 * @method POST /organizations/{organizationId}/projects/{projectId}/people
	 */
	createPerson = async ({
		organizationId,
		projectId,
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/edges
	 */
	track = async ({
		organizationId,
		projectId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/edges`;
		return this.request<unknown>(endpoint, { method: "POST", data });
	};
}
...
class ProjectMembersResource extends BaseResource {
	...
	getProjectMember = async ({
		...
		projectId: string;
		userId: string;
		role: "owner" | "admin" | "editor" | "generation-agent" | "viewer";
		title?: string;
		invitedBy?: string;
		joinedAt?: string;
		createdAt: string;
...
class WebsiteResource extends BaseResource {
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/blog-page
	 */
	getWebsiteBlogPage = async ({
		organizationId,
		projectId,
		appId,
		draftId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/website/${encodeURIComponent(String(appId))}/blog-page`;
	 ...
	 * @method PATCH /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/blog-page
	 */
	updateWebsiteBlogPageMeta = async ({
		organizationId,
		projectId,
		appId,
		data,
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/not-found-page
	 */
	getWebsiteNotFoundPage = async ({
		organizationId,
		projectId,
		appId,
		draftId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/website/${encodeURIComponent(String(appId))}/not-found-page`;
		const params = this.cleanParams({ draftId });
		return this.request<{
			id: string;
			projectId: string;
	 ...
	 * @method PATCH /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/not-found-page
	 */
	updateWebsiteNotFoundPageMeta = async ({
		organizationId,
		projectId,
		appId,
		data,
	...
	/**
	 * Get the one seeded not found page; no create call exists
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/sign-in-page
	 */
	getWebsiteSignInPage = async ({
		organizationId,
		projectId,
		appId,
		draftId,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/website/${encodeURIComponent(String(appId))}/sign-in-page`;
		const params = this.cleanParams({ draftId });
		return this.request<{
			id: string;
			projectId: string;
	...
	/**
	 * Update the not found page's name and SEO fields; cannot publish or edit content
	 * @method PATCH /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/sign-in-page
	 */
	updateWebsiteSignInPageMeta = async ({
		organizationId,
		projectId,
		appId,
		data,
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewer-auth
	 */
	getWebsiteViewerAuth = async ({
		organizationId,
		projectId,
		appId,
	}: {
		...
		accessModel: "invite" | "capture" | "registration";
	}> => {
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/website/${encodeURIComponent(String(appId))}/viewer-auth`;
		return this.request<{
			enabled: boolean;
			tenantId: string | unknown;
			accessModel: "invite" | "capture" | "registration";
	 ...
	 * @method DELETE /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewers/{uid}
	 */
	removeWebsiteViewer = async ({
		organizationId,
		projectId,
		appId,
		uid,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/website/${encodeURIComponent(String(appId))}/viewers/${encodeURIComponent(String(uid))}`;
		return this.request<{
			uid: string;
		}>(endpoint, { method: "DELETE" });
	};
	 ...
	 * @method GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewers
	 */
	listWebsiteViewers = async ({
		organizationId,
		projectId,
		appId,
		page,
		...
		const endpoint = `/organizations/${encodeURIComponent(String(organizationId))}/projects/${encodeURIComponent(String(projectId))}/apps/website/${encodeURIComponent(String(appId))}/viewers`;
		const params = this.cleanParams({ page, pageSize, lite });
		return this.request<{
			data: Array<{
				uid: unknown;
	 ...
	 * @method POST /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewers
	 */
	inviteWebsiteViewer = async ({
		organizationId,
		projectId,
		appId,
		data,
