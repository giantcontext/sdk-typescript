...
describe("GiantContext SDK", () => {
	...
	describe("Builder", () => {
		...
		it("setContentVisibility → POST /organizations/{organizationId}/projects/{projectId}/content/visibility", async () => {
			await gc.builder.setContentVisibility({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				data: { test: true },
			});
			...
			expectFetch(
				"POST",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/content/visibility`,
				{ test: true },
			);
		});
	...
	describe("CRM", () => {
		...
		it("listCrmCompanyEdges → GET /organizations/{organizationId}/projects/{projectId}/apps/crm/{appId}/companies/{companyId}/edges", async () => {
			await gc.crm.listCrmCompanyEdges({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				companyId: "companyId-test",
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/crm/appId-test/companies/companyId-test/edges`,
			);
		});
	...
	describe("Chat", () => {
		...
		it("replyToChatConversation → POST /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/reply", async () => {
			await gc.chat.replyToChatConversation({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				conversationId: "conversationId-test",
			...
			expectFetch(
				"POST",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/chat/appId-test/conversations/conversationId-test/reply`,
				{ test: true },
			);
		});

		it("takeOverChatConversation → POST /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/takeover", async () => {
			await gc.chat.takeOverChatConversation({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				conversationId: "conversationId-test",
			...
			expectFetch(
				"POST",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/chat/appId-test/conversations/conversationId-test/takeover`,
			);
		});

		it("releaseChatConversation → DELETE /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/takeover", async () => {
			await gc.chat.releaseChatConversation({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				conversationId: "conversationId-test",
		...
		it("getChatConversationTimeline → GET /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/timeline", async () => {
			await gc.chat.getChatConversationTimeline({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				conversationId: "conversationId-test",
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/chat/appId-test/conversations/conversationId-test/timeline`,
			);
		});
		...
		it("listChatEscalations → GET /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/escalations", async () => {
			await gc.chat.listChatEscalations({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/chat/appId-test/escalations`,
			);
		});
	});
	...
	describe("People", () => {
		it("erasePerson → POST /organizations/{organizationId}/projects/{projectId}/people/{personId}/erasures", async () => {
			await gc.people.erasePerson({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				personId: "personId-test",
			});

			expectFetch(
				"POST",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/personId-test/erasures`,
			);
		});

		it("setPersonField → PUT /organizations/{organizationId}/projects/{projectId}/people/{personId}/fields", async () => {
			await gc.people.setPersonField({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				personId: "personId-test",
				data: { test: true },
			...
			expectFetch(
				"PUT",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/personId-test/fields`,
				{ test: true },
			);
		});

		it("listPersonEdges → GET /organizations/{organizationId}/projects/{projectId}/people/{personId}/edges", async () => {
			await gc.people.listPersonEdges({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				personId: "personId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/personId-test/edges`,
			);
		});

		it("tagPerson → POST /organizations/{organizationId}/projects/{projectId}/people/{personId}/tags", async () => {
			await gc.people.tagPerson({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				personId: "personId-test",
				data: { test: true },
			...
			expectFetch(
				"POST",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/personId-test/tags`,
				{ test: true },
			);
		});

		it("untagPerson → DELETE /organizations/{organizationId}/projects/{projectId}/people/{personId}/tags", async () => {
			await gc.people.untagPerson({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				personId: "personId-test",
				data: { test: true },
		...
		it("getPersonPropertyKeys → GET /organizations/{organizationId}/projects/{projectId}/people/property-keys", async () => {
			await gc.people.getPersonPropertyKeys({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/property-keys`,
			);
		});

		it("mergePersonPropertyKeys → POST /organizations/{organizationId}/projects/{projectId}/people/property-keys", async () => {
			await gc.people.mergePersonPropertyKeys({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				data: { test: true },
			});
		...
		it("getPerson → GET /organizations/{organizationId}/projects/{projectId}/people/{personId}", async () => {
			await gc.people.getPerson({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				personId: "personId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/personId-test`,
			);
		});

		it("updatePerson → PATCH /organizations/{organizationId}/projects/{projectId}/people/{personId}", async () => {
			await gc.people.updatePerson({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				personId: "personId-test",
				data: { test: true },
		...
		it("getPersonByEmail → GET /organizations/{organizationId}/projects/{projectId}/people/by-email", async () => {
			await gc.people.getPersonByEmail({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				email: "email-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/by-email?email=email-test`,
			);
		});

		it("identify → POST /organizations/{organizationId}/projects/{projectId}/people/identify", async () => {
			await gc.people.identify({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				data: { test: true },
			});
			...
			expectFetch(
				"POST",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people/identify`,
				{ test: true },
			);
		});

		it("listErasures → GET /organizations/{organizationId}/projects/{projectId}/erasures", async () => {
			await gc.people.listErasures({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/erasures`,
			);
		});

		it("listPeople → GET /organizations/{organizationId}/projects/{projectId}/people", async () => {
			await gc.people.listPeople({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/people`,
			);
		});

		it("createPerson → POST /organizations/{organizationId}/projects/{projectId}/people", async () => {
			await gc.people.createPerson({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				data: { test: true },
			});
		...
		it("track → POST /organizations/{organizationId}/projects/{projectId}/edges", async () => {
			await gc.people.track({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				data: { test: true },
			});
			...
			expectFetch(
				"POST",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/edges`,
				{ test: true },
			);
		});
	});
	...
	describe("Website", () => {
		...
		it("getWebsiteBlogPage → GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/blog-page", async () => {
			await gc.website.getWebsiteBlogPage({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/website/appId-test/blog-page`,
			);
		});

		it("updateWebsiteBlogPageMeta → PATCH /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/blog-page", async () => {
			await gc.website.updateWebsiteBlogPageMeta({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				data: { test: true },
		...
		it("getWebsiteNotFoundPage → GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/not-found-page", async () => {
			await gc.website.getWebsiteNotFoundPage({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/website/appId-test/not-found-page`,
			);
		});

		it("updateWebsiteNotFoundPageMeta → PATCH /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/not-found-page", async () => {
			await gc.website.updateWebsiteNotFoundPageMeta({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				data: { test: true },
		...
		it("getWebsiteSignInPage → GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/sign-in-page", async () => {
			await gc.website.getWebsiteSignInPage({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/website/appId-test/sign-in-page`,
			);
		});

		it("updateWebsiteSignInPageMeta → PATCH /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/sign-in-page", async () => {
			await gc.website.updateWebsiteSignInPageMeta({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				data: { test: true },
		...
		it("getWebsiteViewerAuth → GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewer-auth", async () => {
			await gc.website.getWebsiteViewerAuth({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/website/appId-test/viewer-auth`,
			);
		});

		it("removeWebsiteViewer → DELETE /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewers/{uid}", async () => {
			await gc.website.removeWebsiteViewer({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				uid: "uid-test",
			...
			expectFetch(
				"DELETE",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/website/appId-test/viewers/uid-test`,
			);
		});

		it("listWebsiteViewers → GET /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewers", async () => {
			await gc.website.listWebsiteViewers({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
			});
			...
			expectFetch(
				"GET",
				`${baseUrl}/organizations/organizationId-test/projects/projectId-test/apps/website/appId-test/viewers`,
			);
		});

		it("inviteWebsiteViewer → POST /organizations/{organizationId}/projects/{projectId}/apps/website/{appId}/viewers", async () => {
			await gc.website.inviteWebsiteViewer({
				organizationId: "organizationId-test",
				projectId: "projectId-test",
				appId: "appId-test",
				data: { test: true },
